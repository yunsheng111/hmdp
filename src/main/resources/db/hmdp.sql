...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色-权限关联表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '管理员-角色关联表' ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_blog` VALUES (6, 10, 1, '杭州周末好去处｜💰50就可以骑马啦🐎', '/imgs/blogs/blog1.jpg', '杭州周末好去处｜💰50就可以骑马啦🐎', 3, 0, '2025-01-11 16:05:47', '2025-06-08 01:08:02');
INSERT INTO `tb_blog` VALUES (7, 10, 1, '杭州周末好去处｜💰50就可以骑马啦🐎', '/imgs/blogs/blog1.jpg', '杭州周末好去处｜💰50就可以骑马啦🐎', 2, 0, '2025-01-11 16:05:47', '2025-06-07 17:09:32');
INSERT INTO `tb_blog` VALUES (25, 3, 1023, '3333', '/imgs/blogs/6/0/fe70f5f1-847f-4b26-995d-b6868d9ab448.png', '9999', 5, 2, '2025-05-22 14:01:39', '2025-06-08 16:37:42');
INSERT INTO `tb_blog` VALUES (26, 4, 1023, '肉夹馍', '/imgs/blogs/4/3/118e7bac-cbe0-48df-8a00-b6fa936e810f.jpg', '1111111111111111', 24, 2, '2025-05-22 14:13:48', '2025-06-08 15:42:28');
...
INSERT INTO `tb_blog` VALUES (37, 5, 2, '第四次发布', '/imgs/blogs/6/0/090a83fe-d0a1-4fec-9b93-79f58b1b37c4.jfif', '莎米拉实木多层没啥可能', 1, NULL, '2025-05-27 20:25:20', '2025-06-07 17:10:59');
INSERT INTO `tb_blog` VALUES (41, 5, 1, '第四次发布', '/imgs/blogs/10/8/e89a6d78-08f6-49f7-b6ff-9162800d483e.jfif', '啊模块从仓库完成奖', 0, NULL, '2025-06-07 21:20:05', '2025-06-07 21:20:05');
INSERT INTO `tb_blog` VALUES (42, 2, 1, '第五次', '/imgs/blogs/14/4/321bdaad-3bd0-47e0-9ece-564f543d0bbf.jfif', 'nfc;KALnck', 0, NULL, '2025-06-07 21:20:59', '2025-06-07 21:20:59');
...
-- ----------------------------
INSERT INTO `tb_blog_comments` VALUES (1, 1023, 26, 0, 0, '111', 0, 0, '2025-06-08 06:40:52', '2025-06-08 06:40:52');
INSERT INTO `tb_blog_comments` VALUES (2, 1023, 25, 0, 0, '2222', 3, 0, '2025-06-08 06:41:10', '2025-06-08 06:41:55');
INSERT INTO `tb_blog_comments` VALUES (3, 1023, 25, 0, 0, '3333', 0, 0, '2025-06-08 07:08:45', '2025-06-08 07:08:45');
INSERT INTO `tb_blog_comments` VALUES (4, 1023, 26, 0, 0, '15132', 0, 0, '2025-06-08 07:36:14', '2025-06-08 07:36:14');
INSERT INTO `tb_blog_comments` VALUES (11, 1023, 25, 0, 0, '00555666', 0, 1, '2025-06-08 16:37:25', '2025-06-08 16:37:42');
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '购物车主表' ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_cart` VALUES (4, 1023, '2025-06-05 20:10:58', '2025-06-07 21:32:13');
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '购物车项表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评论举报表' ROW_FORMAT = Compact;
...
INSERT INTO `tb_follow` VALUES (9, 1, 1023, '2025-06-07 20:42:04');
INSERT INTO `tb_follow` VALUES (11, 1023, 1, '2025-06-08 00:28:43');
...
CREATE TABLE `tb_merchant`  (
  ...
  `type_id` bigint(0) UNSIGNED NULL DEFAULT NULL COMMENT '商户分类ID，关联tb_shop_type表',
  ...
  INDEX `idx_merchant_type_id`(`type_id`) USING BTREE COMMENT '商户分类索引，用于筛选和关联查询'
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商家信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tb_merchant
-- ----------------------------
INSERT INTO `tb_merchant` VALUES (1, '美食快餐连锁店', 'merchant1', 'e10adc3949ba59abbe56e057f20f883e', '13800138001', '/imgs/merchants/m1.jpg', '提供各类美食快餐，满足您的味蕾需求', 1, 1, NULL, '2025-01-10 12:00:00', '2025-06-08 01:24:41');
INSERT INTO `tb_merchant` VALUES (2, '烤肉店', 'merchant2', 'e10adc3949ba59abbe56e057f20f883e', '13800138002', '/imgs/merchants/m2.jpg', '正宗韩式烤肉，味道纯正', 1, 1, NULL, '2025-01-10 12:00:00', '2025-06-08 01:24:52');
INSERT INTO `tb_merchant` VALUES (3, '咖啡甜品店', 'merchant3', 'e10adc3949ba59abbe56e057f20f883e', '13800138003', '/imgs/merchants/m3.jpg', '提供各类咖啡和甜品，温馨舒适的环境', NULL, 0, NULL, '2025-01-10 12:00:00', '2025-01-10 12:00:00');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商家操作日志表' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_merchant_qualification`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_merchant_id`(`merchant_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商家资质信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商家统计数据表' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_order_comment`  (
  ...
  INDEX `idx_shop_id`(`shop_id`) USING BTREE,
  INDEX `idx_user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单评价表' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_order_item`  (
  ...
  INDEX `idx_product_id`(`product_id`) USING BTREE COMMENT '商品ID索引，用于关联查询'
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单项信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_product`  (
  ...
  INDEX `idx_product_title`(`title`(191)) USING BTREE COMMENT '商品标题索引，用于搜索',
  INDEX `idx_category_status`(`category_id`, `status`) USING BTREE COMMENT '分类和状态组合索引，用于筛选商品'
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tb_product
-- ----------------------------
INSERT INTO `tb_product` VALUES (1, 1, 1, '香辣鸡腿堡套餐', '香辣鸡腿堡+薯条+可乐', '/imgs/product/香辣鸡腿堡套餐.png', 2990, 100, 42, 1, '2025-01-10 12:00:00', '2025-06-08 16:07:02');
INSERT INTO `tb_product` VALUES (2, 1, 1, '双层牛肉堡套餐', '双层牛肉堡+薯条+可乐', '/imgs/product/双层牛肉煲套餐.png', 3290, 100, 35, 1, '2025-01-10 12:00:00', '2025-06-06 21:46:34');
INSERT INTO `tb_product` VALUES (3, 1, 2, '脆皮炸鸡', '黄金脆皮，外酥里嫩', '/imgs/product/脆皮炸鸡.png', 1590, 150, 89, 1, '2025-01-10 12:00:00', '2025-06-06 21:46:34');
INSERT INTO `tb_product` VALUES (4, 1, 2, '薯条', '美式薯条，外酥里软', '/imgs/product/薯条.png', 990, 200, 156, 1, '2025-01-10 12:00:00', '2025-06-06 21:46:34');
INSERT INTO `tb_product` VALUES (5, 1, 3, '冰淇淋', '香草口味冰淇淋', '/imgs/product/冰激凌.png', 590, 200, 95, 1, '2025-01-10 12:00:00', '2025-06-06 21:46:34');
INSERT INTO `tb_product` VALUES (6, 1, 3, '可乐', '冰镇可口可乐', '/imgs/product/可乐.png', 590, 300, 258, 1, '2025-01-10 12:00:00', '2025-06-06 21:46:34');
INSERT INTO `tb_product` VALUES (7, 2, 4, '招牌烤肉拼盘', '多种肉类拼盘，满足各种口味需求', '/imgs/product/招牌烤肉拼盘.png', 9900, 50, 28, 1, '2025-01-10 12:00:00', '2025-06-06 21:46:34');
INSERT INTO `tb_product` VALUES (8, 2, 5, '招牌冷面', '爽口冷面，夏日必备', '/imgs/product/招牌冷面.png', 2800, 80, 63, 1, '2025-01-10 12:00:00', '2025-06-06 21:46:34');
...
CREATE TABLE `tb_product_spec`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_product_id`(`product_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品规格表' ROW_FORMAT = Compact;
...
INSERT INTO `tb_product_spec` VALUES (8, 3, '辣度', '[\"不辣\",\"微辣\",\"中辣\",\"特辣\",\"超级辣\"]', 1, 1, '2025-06-06 21:09:57', '2025-06-06 21:09:57');
INSERT INTO `tb_product_spec` VALUES (9, 4, '份量', '[\"小份\",\"中份\",\"大份\"]', 1, 1, '2025-01-13 12:00:00', '2025-01-13 12:00:00');
INSERT INTO `tb_product_spec` VALUES (10, 4, '调味', '[\"原味\",\"椒盐\",\"番茄味\",\"芝士味\"]', 1, 2, '2025-01-13 12:00:00', '2025-01-13 12:00:00');
INSERT INTO `tb_product_spec` VALUES (11, 5, '口味', '[\"香草\",\"巧克力\",\"草莓\",\"抹茶\"]', 1, 1, '2025-01-13 12:00:00', '2025-01-13 12:00:00');
INSERT INTO `tb_product_spec` VALUES (12, 5, '份量', '[\"单球\",\"双球\",\"三球\"]', 1, 2, '2025-01-13 12:00:00', '2025-01-13 12:00:00');
INSERT INTO `tb_product_spec` VALUES (13, 6, '容量', '[\"小杯\",\"中杯\",\"大杯\"]', 1, 1, '2025-01-13 12:00:00', '2025-01-13 12:00:00');
INSERT INTO `tb_product_spec` VALUES (14, 6, '温度', '[\"常温\",\"冰镇\"]', 1, 2, '2025-01-13 12:00:00', '2025-01-13 12:00:00');
INSERT INTO `tb_product_spec` VALUES (15, 8, '辣度', '[\"不辣\",\"微辣\",\"中辣\",\"特辣\"]', 1, 1, '2025-01-13 12:00:00', '2025-01-13 12:00:00');
INSERT INTO `tb_product_spec` VALUES (16, 8, '配菜', '[\"标准配菜\",\"加蛋\",\"加肉\",\"豪华配菜\"]', 1, 2, '2025-01-13 12:00:00', '2025-01-13 12:00:00');
INSERT INTO `tb_product_spec` VALUES (30, 1, '不要可乐', '[\"香辣鸡腿堡+薯条\"]', 0, 1, '2025-06-08 16:07:02', '2025-06-08 16:07:02');
INSERT INTO `tb_product_spec` VALUES (31, 1, '不要薯条', '[\"香辣鸡腿堡+可乐\"]', 0, 2, '2025-06-08 16:07:02', '2025-06-08 16:07:02');
INSERT INTO `tb_product_spec` VALUES (32, 1, '整个套餐', '[\"香辣鸡腿堡+薯条+可乐\"]', 0, 3, '2025-06-08 16:07:02', '2025-06-08 16:07:02');
...
-- ----------------------------
INSERT INTO `tb_seckill_voucher` VALUES (12, 100, '2025-01-18 20:20:59', '2025-01-10 20:07:18', '2025-05-18 12:07:18', '2025-06-08 16:01:03');
...
CREATE TABLE `tb_shop`  (
  `id` bigint(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `merchant_id` bigint(0) UNSIGNED NULL DEFAULT NULL COMMENT '商家ID',
  ...
  `status` tinyint(0) UNSIGNED NOT NULL DEFAULT 1 COMMENT '营业状态，0-休息，1-营业',
...
CREATE TABLE `tb_shop_comment`  (
  ...
  `reply` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '商家回复内容',
  ...
  INDEX `idx_order_id`(`order_id`) USING BTREE,
  INDEX `idx_create_time`(`create_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商店评论表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tb_shop_comment
-- ----------------------------
INSERT INTO `tb_shop_comment` VALUES (1, 1, 1, 100001, 5, '服务很好，环境不错，菜品也很棒！', NULL, 0, '2025-01-10 14:30:00', '2025-01-10 14:30:00');
INSERT INTO `tb_shop_comment` VALUES (2, 1, 2, 100002, 4, '味道还可以，就是上菜有点慢', NULL, 0, '2025-01-10 15:20:00', '2025-01-10 15:20:00');
INSERT INTO `tb_shop_comment` VALUES (3, 2, 1, 100003, 5, '烤肉非常棒，下次还会再来！', NULL, 0, '2025-01-10 20:15:00', '2025-01-10 20:15:00');
INSERT INTO `tb_shop_comment` VALUES (4, 2, 2, 100004, 3, '价格有点贵，性价比一般', NULL, 0, '2025-01-10 21:00:00', '2025-01-10 21:00:00');
INSERT INTO `tb_shop_comment` VALUES (5, 3, 1023, NULL, 4, '环境很好，适合聚餐', NULL, 0, '2025-01-11 12:30:00', '2025-01-11 12:30:00');
...
INSERT INTO `tb_shop_type` VALUES (8, '酒吧', '/types/jiuba.png', 9, '2024-12-22 20:20:02', '2025-02-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (9, '剧本杀', '/types/hpg.png', 8, '2024-12-22 20:20:08', '2025-02-23 11:24:31');
...
CREATE TABLE `tb_user`  (
  ...
  `status` int(0) NOT NULL COMMENT '用户状态，0：正常，1：禁用',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '人物头像',
  `create_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uniqe_key_phone`(`phone`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1027 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (1, '13686869696', '123456', '小鱼同学', 0, '/imgs/blogs/blog1.jpg', '2025-02-22 10:27:19', '2025-06-07 19:34:47');
INSERT INTO `tb_user` VALUES (2, '13838411438', '', '可可今天不吃肉', 0, '/imgs/icons/kkjtbcr.jpg', '2025-02-22 15:14:39', '2025-05-26 15:24:31');
INSERT INTO `tb_user` VALUES (4, '13456789011', '', 'user_slxaxy2au9f3tanffaxr', 0, '', '2025-02-22 12:07:53', '2025-02-22 12:07:53');
INSERT INTO `tb_user` VALUES (5, '13456789001', '', '可爱多', 0, '/imgs/icons/user5-icon.png', '2025-02-22 16:11:33', '2025-05-26 15:25:16');
INSERT INTO `tb_user` VALUES (1012, '13021256644', '', 'user_v5l4bi6pa2', 0, '', '2025-01-03 21:21:55', '2025-01-03 21:21:55');
INSERT INTO `tb_user` VALUES (1013, '13322554466', '', 'user_qk0fzu63p8', 0, '', '2025-01-04 19:26:28', '2025-01-04 19:26:28');
INSERT INTO `tb_user` VALUES (1014, '13223568877', '', '小张', 0, '', '2025-01-04 20:30:55', '2025-06-08 01:48:46');
INSERT INTO `tb_user` VALUES (1015, '13011576645', '', '小王', 0, '', '2025-01-04 21:04:24', '2025-06-08 01:40:09');
INSERT INTO `tb_user` VALUES (1016, '13255697711', '', 'user_799ezgpaig', 0, '', '2025-01-04 21:07:24', '2025-06-08 01:35:02');
INSERT INTO `tb_user` VALUES (1017, '13211112222', '', 'user_f68wcwci9x', 0, '', '2025-01-04 21:11:31', '2025-01-04 21:11:31');
INSERT INTO `tb_user` VALUES (1018, '13300002222', '', 'user_m78cp1lgyi', 0, '', '2025-01-04 21:21:52', '2025-01-04 21:21:52');
INSERT INTO `tb_user` VALUES (1019, '13011123333', '', 'user_oqqyvcwojc', 0, '', '2025-01-04 21:23:55', '2025-01-04 21:23:55');
INSERT INTO `tb_user` VALUES (1020, '13222556655', '9zn69eoh', 'user_13222556655', 0, '', '2025-01-04 23:16:55', '2025-01-04 23:16:55');
INSERT INTO `tb_user` VALUES (1021, '13312120222', '18xp28wr', 'user_13312120222', 0, '', '2025-01-05 18:27:34', '2025-01-05 18:27:34');
INSERT INTO `tb_user` VALUES (1022, '13022221111', 'dmn95gjv', 'user_13022221111', 0, '', '2025-01-10 18:30:39', '2025-01-10 18:30:39');
INSERT INTO `tb_user` VALUES (1023, '13011112222', '123456', 'user_13011112222', 0, '', '2025-01-10 18:31:13', '2025-06-07 19:20:09');
INSERT INTO `tb_user` VALUES (1024, '13322223333', 'wap3vwml', 'user_13322223333', 0, '', '2025-01-31 16:00:21', '2025-01-31 16:00:21');
INSERT INTO `tb_user` VALUES (1025, '13322221111', 'l7bbsq1f', 'user_13322221111', 0, '', '2025-05-21 09:54:25', '2025-05-21 09:54:25');
INSERT INTO `tb_user` VALUES (1026, '13311112222', 'yefoeyz5', 'user_13311112222', 0, '', '2025-05-22 12:37:50', '2025-05-22 12:37:50');
...
CREATE TABLE `tb_voucher`  (
  ...
  `min_amount` bigint(0) UNSIGNED NULL DEFAULT NULL COMMENT '最低消费金额，单位为分',
  `valid_days` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '有效天数',
...
-- ----------------------------
INSERT INTO `tb_voucher` VALUES (1, 1, '50元代金券', '周一至周日均可使用', '全场通用，无需预约，可无限叠加，不兑现，不找零，仅限堂食', 4750, 5000, 100, 30, 0, 1, '2025-02-04 09:42:39', '2025-06-08 15:29:24');
INSERT INTO `tb_voucher` VALUES (12, 1, '100元代金券', '周一至周五均可使用', '全场通用，无需预约，可无限叠加，不兑现，不找零，仅限堂食', 8000, 10000, 100, 30, 1, 1, '2025-01-18 20:20:59', '2025-06-08 16:01:03');
...
CREATE TABLE `tb_voucher_order`  (
  ...
  `shop_id` bigint(0) UNSIGNED NULL DEFAULT NULL COMMENT '关联的商铺id',
